...
static const char __pyx_k_Hello_this_is_gonna_be_a_test_of[] = "Hello, this is gonna be a test of cython";
static PyObject *__pyx_kp_s_Hello_this_is_gonna_be_a_test_of;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_Hello_this_is_gonna_be_a_test_of, __pyx_k_Hello_this_is_gonna_be_a_test_of, sizeof(__pyx_k_Hello_this_is_gonna_be_a_test_of), 0, 0, 1, 0},
...
if (!__Pyx_RefNanny) {
  ...
  /* "hello.pyx":1
 * print('Hello, this is gonna be a test of cython')             # <<<<<<<<<<<<<<
 */
  if (__Pyx_PrintOne(0, __pyx_kp_s_Hello_this_is_gonna_be_a_test_of) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
